...
GlobalEntities = {1000: {'type': 'levelMgr',
 ...
 10014: {'type': 'goon', #red goon
         ...
         'scale': random.choice([0.7, 0.8, 0.9, 1.0, 1.1, 1.2]),
         'attackRadius': random.choice([7, 8, 9, 10, 11, 12, 13, 14, 15]),
         'crushCellId': None,
         'goonType': 'pg',
         'gridId': None,
         'hFov': 70,
         'strength': random.choice([10, 11, 12, 13]),
         'velocity': random.choice([3, 4, 5, 6, 7, 8])},
 10025: {'type': 'goon', #red goon
         'name': '<unnamed>',
         'comment': '',
         'parentEntId': 10022,
         'pos': Point3(0.0, 0.0, 0.0),
