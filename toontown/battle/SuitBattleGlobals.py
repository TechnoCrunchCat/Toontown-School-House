...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'cc': {'name': TTLocalizer.SuitColdCaller,
        ...
        'acc':(35,40,45,50,55),
        'attacks':
                (('Watercooler', #Why the fuck was this a bitch to add
                    (3,4,5,6,7),
                    (50,55,60,65,70),
                    (10,15,20,25,30)),
                ('FreezeAssets',
...
'tm': {'name': TTLocalizer.SuitTelemarketer,
 ...
 'mb': {'name': TTLocalizer.SuitMoneyBags,
        ...
        'level': 5,
        'hp':(56,72,90,110,132,156,200),
        'def':(25,30,35,40,45,50,55),
        'freq':(50,30,10,5,5),
        'acc':(35,40,45,50,55,55,60),
        'attacks':
                (('Liquidate',
                    (10,12,14,16,18,19,20),
                    (60,75,80,85,90,90,92),
                    (30,30,30,30,30,30,30)),
                ('MarketCrash',
                    (8,10,12,14,16,17,20),
                    (60,65,70,75,80,81,82),
                    (45,45,45,45,45,45,45)),
                ('PowerTie',
                    (6,7,8,9,10,11,13),
                    (60,65,75,85,90,93,95),
                    (25,25,25,25,25,25,25)))},
 'ls': {'name': TTLocalizer.SuitLoanShark,
        'singularname': TTLocalizer.SuitLoanSharkS,
        'pluralname': TTLocalizer.SuitLoanSharkP,
        'level': 6,
        'hp':(72,90,110,132,156,200,462),
        'def':(30,35,40,45,50,55,60),
        'freq':(50,30,10,5,5),
        'acc':(35,40,45,50,55,60,66),
        'attacks':
                (('Bite',
                    (10,11,13,15,16,18,23),
                    (60,75,80,85,90,92,92),
                    (30,30,30,30,30,30,30)),
                ('Chomp',
                    (12,15,18,21,24,25,26),
                    (60,70,75,80,90,91,93),
 ...
 'bw': {'name': TTLocalizer.SuitBigWig,
        ...
        'attacks':
                ...
                ('PowerTrip',
                    ...
                    (50,50,50,50,50,50,50,50,50,50,50,50,50,50)),
                ('ThrowBook', #Model for Book needs to be tweaked and resized
                    (13,15,17,19,21,23,25,27,29,32,34,36,38,40),
                    (80,85,85,85,90,90,90,90,95,95,95,95,95,95),
                    (50,50,50,50,50,50,50,50,50,50,50,50,50,50)))}}
